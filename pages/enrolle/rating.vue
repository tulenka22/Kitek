  ...
  data() {
    return {
      ...
      srecs: [
        {
          abgroup: 'rmp',
          name: 'Разработка и управление програмным обеспечением (Разработка мобильных приложений)',
          description: 'база: 9 класс, квалификация: программист',
          p: '50',
        },
        {
          abgroup: 'vr',
          name: 'Разработка и управление програмным обеспечением (Веб-разработка)',
          description: 'база: 9 класс, квалификация: программист',
          p: '50',
        },
        {
